...
const genres = [
  { value: "thriller", label: "Thriller / Suspense", description: "Tensión, peligro y giros inesperados" },
  { value: "psychological-thriller", label: "Thriller Psicológico", description: "Manipulación mental y narradores poco fiables" },
  { value: "police-procedural", label: "Thriller Policial", description: "Investigaciones policiales detalladas" },
  { value: "domestic-thriller", label: "Thriller Doméstico", description: "Secretos oscuros en la vida cotidiana" },
  { value: "romance", label: "Romance Contemporáneo", description: "Historias de amor en el presente" },
  { value: "historical-romance", label: "Romance Histórico", description: "Amor en épocas pasadas (Regencia, Victorian)" },
  { value: "paranormal-romance", label: "Romance Paranormal", description: "Amor con seres sobrenaturales" },
  { value: "dark-romance", label: "Dark Romance", description: "Romance con temas oscuros y moralmente grises" },
  { value: "romantasy", label: "Romantasy", description: "Romance + Fantasía (trending 2024-2026)" },
  { value: "fantasy", label: "Fantasía Épica", description: "Mundos mágicos y aventuras épicas" },
  { value: "urban-fantasy", label: "Fantasía Urbana", description: "Magia en ciudades modernas" },
  { value: "grimdark", label: "Fantasía Oscura (Grimdark)", description: "Fantasía con antihéroes y violencia" },
  { value: "sci-fi", label: "Ciencia Ficción", description: "Tecnología y exploración espacial" },
  { value: "space-opera", label: "Space Opera", description: "Aventuras épicas en el espacio" },
  { value: "dystopia", label: "Distopía / Post-apocalíptico", description: "Futuros sombríos y supervivencia" },
  { value: "horror", label: "Terror / Horror", description: "Miedo, horror sobrenatural" },
  { value: "psychological-horror", label: "Terror Psicológico", description: "Horror mental sin elementos sobrenaturales" },
  { value: "mystery", label: "Misterio", description: "Investigación y resolución de enigmas" },
  { value: "cozy-mystery", label: "Cozy Mystery", description: "Misterio acogedor sin violencia explícita" },
  { value: "crime-noir", label: "Crime Fiction / Noir", description: "Crimen urbano y atmósfera oscura" },
  { value: "historical", label: "Ficción Histórica", description: "Narrativas en contextos del pasado" },
  { value: "historical-thriller", label: "Thriller Histórico", description: "Suspense en contextos históricos" },
  { value: "literary", label: "Literaria", description: "Exploración de la condición humana" },
  { value: "young-adult", label: "Young Adult (YA)", description: "Protagonistas adolescentes (15-18 años)" },
  { value: "new-adult", label: "New Adult (NA)", description: "Protagonistas jóvenes adultos (18-25 años)" },
  { value: "litrpg", label: "LitRPG / GameLit", description: "Aventuras con mecánicas de videojuegos" },
  { value: "erotic", label: "Erótico", description: "Romance con contenido adulto explícito" },
  { value: "adventure", label: "Aventura", description: "Viajes y descubrimientos épicos" },
  { value: "women-fiction", label: "Women's Fiction", description: "Journeys emocionales de protagonistas femeninas" },
  { value: "mafia-romance", label: "Mafia Romance", description: "Romance con elementos criminales (trending)" },
  { value: "reverse-harem", label: "Reverse Harem / Why Choose", description: "Múltiples intereses amorosos" },
];
