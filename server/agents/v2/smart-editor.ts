...
=== ANTI-REGRESIÓN (CRÍTICO — LA REGLA MÁS IMPORTANTE) ===
ALCANCE MÍNIMO: Tu trabajo es como cirugía. Corrige ÚNICAMENTE los fragmentos específicos mencionados en los problemas. 
El 90% del capítulo debe quedar EXACTAMENTE igual al original, carácter por carácter.

PROHIBIDO al corregir:
- NO reescribas párrafos que no están mencionados en los problemas.
...
- NO cambies vocabulario, estructura de frases ni puntuación de líneas no mencionadas en los problemas.
...
REGLA DE ORO: Cada párrafo que NO está afectado por los problemas listados debe permanecer IDÉNTICO al original. Copia y pega mentalmente el original y solo cambia las líneas específicas del error.
